...
public class FormViewController2 {
	@FXML
	...
	private void add() {
		...
		String commandName = "replace_if_greater";
		...
		Organization organization = new Organization(id, organizationName, organizationFullname, annualTurnover, employeesCount, organizationType);
		Product product = new Product(id, name, coordinates, creationDate, price, partNumber, manufactureCost, unit, organization);
